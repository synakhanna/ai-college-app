            ...
            <div className="custom-screen">
                <div className="py-8 border-t border-gray-800 items-center justify-between sm:flex">
                    ...
                    <div className="flex items-center justify-center gap-x-6 text-gray-500 mt-6 sm:mt-0">
                        ...
                        <a href="https://www.linkedin.com/company/codefusionartificialintelligence/posts/?feedView=all" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                        ...
                        <a href="https://linktr.ee/codefusionai" target="_blank" rel="noreferrer" aria-label="Linktree">
